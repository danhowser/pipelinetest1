...
<link rel="stylesheet" href="http://maxcdn.bootstapcdn.com/bootstrap/3.3.5/css/bootstrap.min.css">
<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.3/jquery.min.css"></script>
<script src="http://maxcdn.bootstapcdn.com/bootstrap/3.3.5/css/bootstrap.min.js"></script>
...
<li class="next"><a href="<%= StringUtils.replace(pagedLink, 
   "~", String.valueOf(pagedListHolder.getPage()+1)) %>">></a></li>
</c:if>
</ul>
</c:if>