...
<nav class="navbar navbar-inverse" role="banner">
                    ...
                    <div class="recent-work-wrap">
                        ...
                        <div class="overlay">
                            <div class="recent-work-inner">
                                ...
                                <a class="preview" href="<c:url value="/resources/images/portfolio/full/item1.png"/>" rel="prettyPhoto"><i class="fa fa-eye"></i> View</a>
                            </div> 
                        </div>
                    </div>
                </div>   
                    ...
                    <div class="recent-work-wrap">
                        ...
                        <div class="overlay">
                            <div class="recent-work-inner">
                                <h3><a href="#">Business theme </a></h3>
                                <p>There are many variations of passages of Lorem Ipsum available, but the majority</p>
                                <a class="preview" href="<c:url value="/resources/images/portfolio/full/item7.png"/>" rel="prettyPhoto"><i class="fa fa-eye"></i> View</a>
                            </div> 
                        </div>
                    </div>
                </div>   
	...
	<script src="${pageContext.request.contextPath}/resources/js/coca.js"></script>
